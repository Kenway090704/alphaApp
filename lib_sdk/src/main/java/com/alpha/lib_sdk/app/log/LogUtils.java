...
/**
 * A LogUtils tools. Invoked {@link #setLogPrinter(ILogPrinter)} to set a
 * {@link ILogPrinter} to do a real LogUtils action.
 *
 * @author AlbieLiang
 */
public class LogUtils {
    ...
    public static void v(String message,Object...args) {
        ...
        if (LEVEL <= VERBOSE) {
            ...
            if (isUserOther)
            sLogPrinter.printLog(VERBOSE, tag, message,args);
        }
    }
    ...
    public static void d(String message,Object...args) {
        ...
        if (LEVEL <= DEBUG) {
            ...
            if (isUserOther)
            sLogPrinter.printLog(DEBUG, tag, message,args);
        }
    }
    ...
    public static void i(String message,Object...args) {
        ...
        if (LEVEL <= INFO) {
            ...
            if (isUserOther)
            sLogPrinter.printLog(INFO, tag, message,args);
        }
    ...
    public static void e(String tag, String message,Object...args) {
        ...
        if (LEVEL <= ERROR) {
            ...
            if (isUserOther)
              sLogPrinter.printLog(ERROR, tag,message,args);
        }
    }
    ...
    public static void w(String message,Object...args) {
        ...
        if (LEVEL <= WARN) {
            ...
            if (isUserOther)
            sLogPrinter.printLog(WARN, tag, message,args);
        }
    }
