package com.alpha.alphaapp.ui.v_1_0.sign.adapter;
...
public class MySignDateAdapter extends RecyclerView.Adapter<MySignDateAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.adapter_my_sign_item, parent, false));
