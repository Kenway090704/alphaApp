...
public class UserTopicsActivtiy extends AbsBaseListActivity {
    ...
    public RecyclerView initRecylerView(View view) {
        RecyclerView rv = (RecyclerView) findViewById(R.id.acty_user_topics_rv);
    ...
    public SwipeRefreshLayout initSwipeRefreshLayout(View view) {
        SwipeRefreshLayout sw = (SwipeRefreshLayout) findViewById(R.id.acty_user_topics_sw);
        return sw;
    }
    ...
    public static void actionStart(Context context, String uid) {
        Intent intent = new Intent(context, UserTopicsActivtiy.class);
