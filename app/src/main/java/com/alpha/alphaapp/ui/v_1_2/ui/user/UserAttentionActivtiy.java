...
public class UserAttentionActivtiy extends AbsBaseListActivity {
    ...
    public RecyclerView initRecylerView(View view) {
        RecyclerView rv = (RecyclerView) findViewById(R.id.acty_user_attention_rv);
    ...
    public SwipeRefreshLayout initSwipeRefreshLayout(View view) {
        SwipeRefreshLayout sw = (SwipeRefreshLayout) findViewById(R.id.acty_user_attention_sw);
        return sw;
    }
    ...
    public static void actionStart(Context context, String uid) {
        Intent intent = new Intent(context, UserAttentionActivtiy.class);
