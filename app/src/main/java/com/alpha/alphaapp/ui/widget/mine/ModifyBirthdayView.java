...
public class ModifyBirthdayView extends LinearLayout {
    ...
    public ModifyBirthdayView(Context context) {
        super(context);
    }

    public ModifyBirthdayView(Context context, AttributeSet attrs) {
        super(context, attrs);
