...
public class ActiveEnterItemInfo {
    ...
    private int srcId;
    private int tv_active_time;
    private int tv_active_tiem_2;
    /**
     * 官网地址
     */
    ...
    public int getTv_active_time() {
        return tv_active_time;
    }

    public void setTv_active_time(int tv_active_time) {
    ...
    public int getTv_active_tiem_2() {
        return tv_active_tiem_2;
    }

    public void setTv_active_tiem_2(int tv_active_tiem_2) {
